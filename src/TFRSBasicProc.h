...
protected:
  ...
  TH1I* MakeH1ISeriesLabel(const char* foldername, Int_t seriesnumber, const char* labelname, Int_t crate, Int_t number, Bool_t remove);
	TH1I* MakeH1ISeriesV1290raw(const char* foldername, Int_t seriesnumber, Int_t crate, Int_t number, Bool_t remove);
	TH1I* MakeH1ISeriesV1290multip(const char* foldername, Int_t seriesnumber, Int_t crate, Int_t number, Bool_t remove);
   TH1I* MakeH1ISeriesV1190raw(const char* foldername, Int_t seriesnumber, Int_t crate, Int_t number, Bool_t remove);
