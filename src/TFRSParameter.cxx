...
TLABRParameter::TLABRParameter() : TGo4Parameter("TLABRParameter")
{
   labr_factor_2_1 = 0.;
   labr_factor_2_2 = 0.;
   labr_factor_2_3 = 0.;
...
TLABRParameter::TLABRParameter(const char* name) : TGo4Parameter(name)
{
   labr_factor_2_1 = 0.;
   labr_factor_2_2 = 0.;
   labr_factor_2_3 = 0.;
...
Bool_t TLABRParameter::UpdateFrom(TGo4Parameter* par) {
  TLABRParameter *from = dynamic_cast<TLABRParameter*> (par);
  if (from==0) {
    std::cout << "Wrong parameter object: " << par->ClassName() << std::endl; 
    return kFALSE;   
  }
   labr_factor_2_1 = from->labr_factor_2_1;
   labr_factor_2_2 = from->labr_factor_2_2;
   labr_factor_2_3 = from->labr_factor_2_3;
   labr_factor_2_4 = from->labr_factor_2_4;
   labr_factor_2_5 = from->labr_factor_2_5;
   labr_factor_2_6 = from->labr_factor_2_6;
   labr_factor_2_7 = from->labr_factor_2_7;
   labr_factor_2_8 = from->labr_factor_2_8;

   labr_factor_1_1 = from->labr_factor_1_1;
   labr_factor_1_2 = from->labr_factor_1_2;
   labr_factor_1_3 = from->labr_factor_1_3;
   labr_factor_1_4 = from->labr_factor_1_4;
   labr_factor_1_5 = from->labr_factor_1_5;
   labr_factor_1_6 = from->labr_factor_1_6;
   labr_factor_1_7 = from->labr_factor_1_7;
   labr_factor_1_8 = from->labr_factor_1_8;
  
   labr_offset1 = from->labr_offset1;
   labr_offset2 = from->labr_offset2;
   labr_offset3 = from->labr_offset3;
   labr_offset4 = from->labr_offset4;
   labr_offset5 = from->labr_offset5;
   labr_offset6 = from->labr_offset6;
   labr_offset7 = from->labr_offset7;
   labr_offset8 = from->labr_offset8;
...
Bool_t TSCIParameter::UpdateFrom(TGo4Parameter* par) {
  ...
  // SCI dE from Mesytec QDC
  le_mqdc_a_21[0] = from -> le_mqdc_a_21[0];
  le_mqdc_a_21[1] = from -> le_mqdc_a_21[1];
  re_mqdc_a_21[0] = from -> re_mqdc_a_21[0];
  re_mqdc_a_21[1] = from -> re_mqdc_a_21[1];
  le_mqdc_a_22[0] = from -> le_mqdc_a_22[0];
  le_mqdc_a_22[1] = from -> le_mqdc_a_22[1];
  re_mqdc_a_22[0] = from -> re_mqdc_a_22[0];
  re_mqdc_a_22[1] = from -> re_mqdc_a_22[1];
  le_mqdc_a_41[0] = from -> le_mqdc_a_41[0];
  le_mqdc_a_41[1] = from -> le_mqdc_a_41[1];
  re_mqdc_a_41[0] = from -> re_mqdc_a_41[0];
  re_mqdc_a_41[1] = from -> re_mqdc_a_41[1];
  le_mqdc_a_42[0] = from -> le_mqdc_a_42[0];
  le_mqdc_a_42[1] = from -> le_mqdc_a_42[1];
  re_mqdc_a_42[0] = from -> re_mqdc_a_42[0];
  re_mqdc_a_42[1] = from -> re_mqdc_a_42[1];
  le_mqdc_a_81[0] = from -> le_mqdc_a_81[0];
  le_mqdc_a_81[1] = from -> le_mqdc_a_81[1];
  re_mqdc_a_81[0] = from -> re_mqdc_a_81[0];
  re_mqdc_a_81[1] = from -> re_mqdc_a_81[1];
...
Bool_t TRangeParameter::UpdateFrom(TGo4Parameter* par) {
  ...
  s4_matter = from->s4_matter;
  s41_deg_matter = from->s41_deg_matter;
